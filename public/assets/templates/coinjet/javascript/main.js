   ...
   'use strict'
    ...
    var retinaLogos = function() {
      var retina = window.devicePixelRatio > 1 ? true : false;
        if(retina) {
            $('.logo').find('img').attr({src:'https://aamclick.com/assets/templates/coinjet/images/logo.png',width:'131',height:'21'}); 
        }

        if(retina) {
            $('#logo-ft').find('img').attr({src:'https://aamclick.com/assets/templates/coinjet/images/logo.png',width:'133',height:'21'}); 
        }
    }; 
