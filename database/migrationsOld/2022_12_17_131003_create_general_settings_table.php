...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('general_settings', function (Blueprint $table) {
            ...
            $table->decimal('registration_bonus', 28, 8)->default(0);
            $table->decimal('bt_fixed', 28, 8)->default(0);
            $table->decimal('bt_percent', 28, 8)->default(0);
            ...
            $table->tinyInteger('ad_auto_approve')->default(0);
            $table->text('ads_setting')->nullable();
            $table->string('website_phone', 20);
            $table->string('website_email', 20);
            $table->tinyInteger('profit_bonus')->default(0);
            $table->decimal('profit_bonus_percentage', 28, 8)->nullable()->default(0);
            $table->integer('profit_bonus_days')->default(0);
            $table->timestamps();
        });
    }
