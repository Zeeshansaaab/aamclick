...
class NotificationController extends Controller
{
    ...
    public function emailSettingUpdate(Request $request)
    {
        $request->validate([
            ...
            'aam_id' => 'required_if:email_method,smtp',
            ...
            'aam_id.required_if' => ':attribute is required for SMTP configuration',
        ...
        if ($request->email_method == 'php') {
            ...
            $data = $request->only('name', 'host', 'port', 'enc', 'aam_id', 'password', 'driver');
   ...
   public  function smsSetting(){
    ...
    public function smsSettingUpdate(Request $request){
        $request->validate([
            ...
            'infobip_aam_id' => 'required_if:sms_method,infobip',
            'infobip_password' => 'required_if:sms_method,infobip',
            'sms_broadcast_aam_id' => 'required_if:sms_method,smsBroadcast',
            'sms_broadcast_password' => 'required_if:sms_method,smsBroadcast',
            'text_magic_aam_id' => 'required_if:sms_method,textMagic',
        ...
        $data = [
            ...
            'sms_broadcast'=>[
                'aam_id'=>$request->sms_broadcast_aam_id,
            ...
            'text_magic'=>[
                'aam_id'=>$request->text_magic_aam_id,
