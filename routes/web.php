...
Route::get('check',[App\Http\Controllers\Admin\DevideProfitController::class,'cronProfitBonus']);
// User Support Ticket
...
Route::controller('SiteController')->group(function () {
    ...
    Route::get('committee-plans', 'SiteController@committeePlans')->name('committeePlans');
    Route::get('committees-list/{planid}', 'SiteController@committees')->name('committeeList');
