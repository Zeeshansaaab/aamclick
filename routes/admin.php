...
use App\Http\Controllers\Admin\ProfitTrackerController;
...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function(){
        ...
        Route::resource('tracker', ProfitTrackerController::class);
    });
    ...
    Route::controller('ReferralController')->name('referrals.')->prefix('referrals')->group(function(){
        ...
        Route::get('/change-referral/{user}', 'changeReferral')->name('change');
        Route::post('/change-referral-store', 'changeReferralStore')->name('change.store');
    });
    ...
    // Devide Profit
    Route::name('devideProfit.')->prefix('devide-profit')->group(function () {

        Route::controller('DevideProfitController')->group(function () {
            Route::get('devide-profit', 'devideProfitForm')->name('form');
            Route::post('devide-profit-submit', 'devide')->name('submit');

            // Add Daily Profit
            Route::get('add-daily-profit', 'addDailyProfitForm')->name('dailyProfit');
            Route::post('add-daily-profit-submit', 'dailyProfitSubmit')->name('dailyProfit.submit');
        });

    });

    // Withdrawal Types
    Route::name('withdrawType.')->prefix('withdraw-type')->group(function () {
        Route::controller('WithdrawalTypeController')->group(function () {
    ...
    Route::name('committee.')->prefix('committee')->group(function () {
        Route::controller('CommitteeController')->group(function () {
            ...
            Route::name('committee.')->prefix('committee')->group(function () {
                Route::get('/{planid}', 'committeesIndex')->name('index');
                Route::get('/{planid}/create', 'committeeCreate')->name('create');
                Route::post('/{planid}/store', 'committeeStore')->name('store');
                Route::get('/{planid}/edit/{id}', 'committeeEdit')->name('edit');
                Route::post('/{planid}/update/{id}', 'committeeUpdate')->name('update');
            });

            Route::name('members.')->prefix('members')->group(function () {
                Route::get('index', 'committeeMembers')->name('index');
            });
        });
    });
