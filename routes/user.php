...
Route::middleware('auth')->name('user.')->group(function () {
    ...
    Route::get('/members', function(){
        $members = CommissionLog::with('userFrom')
    ...
    Route::middleware(['check.status'])->group(function () {
        ...
        Route::middleware('registration.complete')->namespace('User')->group(function () {
            Route::controller('UserController')->group(function(){
                ...
                // Committee System
                Route::get('committees-list/{complanid}/committee-members/{committeeid}', 'committeeMembers')->name('committeeMembers');
                Route::post('add-committee-member','addCommitteeMember')->name('addCommitteeMember');
                Route::get('committee-history', 'committeeHistory')->name('committee.history');
        ...
        //Installments
        Route::resource('installments', App\Http\Controllers\User\InstallmentController::class);
