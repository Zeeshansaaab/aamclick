                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label class="form-label">@lang('Deposit type')</label>
                                <select class="form-select form--select" name="type" required>
                                    <option value="">@lang('Select One')</option>
                                    <option value="1">Default</option>
                                    <option value="2">Committee Installments</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" name="amount"  class="form-control" value="{{ old('amount') }}" placeholder="Enter amount" autocomplete="off" required>
                                </div>
                            </div>
