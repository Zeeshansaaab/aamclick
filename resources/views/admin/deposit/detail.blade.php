...
@section('panel')
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('User ID')
                            <span class="fw-bold">
                                <a href="{{ route('admin.users.detail', $deposit->user_id) }}">{{ @$deposit->user->aam_id }}</a>
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Method')
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                ...
                                <button class="btn btn--danger ms-1 rejectBtn"
                                        ...
                                        data-aam_id="{{ @$deposit->user->aam_id }}"><i class="fas fa-ban"></i> @lang('Reject')
                                </button>
                            </div>
                        </div>
                    @endif
    ...
    <div class="row mb-30 mt-30 justify-content-center">
        <div class="col-xl-12 col-md-12 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="card-title mb-50 border-bottom pb-2">@lang('User Deposit list Information')</h5>
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <table class="table">
                                <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $general->cur_sym . showAmount($deposit->amount) }}</td>
                                        <td>{{ $deposit->method_currency . ' ' . showAmount($deposit->final_amo) }}</td>
                                    </tr>
                                    @empty
                                    <tr>
    ...
    <script>
        (function ($) {
            ...
            $('.rejectBtn').on('click', function () {
                ...
                modal.find('.withdraw-user').text($(this).data('aam_id'));
                modal.modal('show');
            });
        })(jQuery);
    </script>
