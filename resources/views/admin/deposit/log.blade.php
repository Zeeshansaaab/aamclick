                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('User')">
                                    ...
                                    <br>
                                    <span class="small">
                                    <a href="{{ appendQuery('search',@$deposit->user->aam_id) }}"><span>@</span>{{ $deposit->user->aam_id }}</a>
                                    </span>
                                </td>
                                ...
                                <td data-label="@lang('Type')">
                                    ...
                                    @elseif($deposit->type == 2)
                                        <strong>Committee Installments</strong>
        ...
        <form action="" method="GET">
            <div class="form-inline float-sm-end mb-2 ms-0 ms-xl-2 ms-lg-0">
                <div class="input-group">
                    <input type="text" name="search" class="form-control bg--white" placeholder="@lang('Trx number/User ID')" value="{{ request()->search ?? '' }}">
