    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                        ...
                        <a href="{{ route('admin.report.transaction') }}?search={{ $user->aam_id }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                        ...
                        <a href="{{ route('admin.deposit.list') }}?search={{ $user->aam_id }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                        ...
                        <a href="{{ route('admin.withdraw.log') }}?search={{ $user->aam_id }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ getAmount($user->user_profit_bonus, 2) }}</h3>
                            <p class="text-white">@lang('Profit Bonus')</p>
                        </div>
                        <a href="{{ route('admin.report.transaction') }}?search={{ $user->aam_id }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ getAmount($user->profit_bonus, 2) }}</h3>
                            <p class="text-white">@lang('Referral income')</p>
                        </div>
                        <a href="{{ route('admin.report.transaction') }}?search={{ $user->aam_id }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ getAmount($user->deposit_commission, 2) }}</h3>
                            <p class="text-white">@lang('Referral Deposit')</p>
                        </div>
                        <a href="{{ route('admin.report.transaction') }}?search={{ $user->aam_id }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                 <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <div class="widget-two__content">
                            <p class="text-white">@lang('Change Referals')</p>
                        </div>
                        <a href="{{ route('admin.referrals.change', $user->id) }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                <div class="flex-fill">
                    <a href="{{route('admin.report.login.history')}}?search={{ $user->aam_id }}" class="btn btn--primary btn--shadow w-100 btn-lg">
