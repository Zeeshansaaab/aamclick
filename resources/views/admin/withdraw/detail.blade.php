...
@section('panel')
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('User ID')
                            <span class="fw-bold">
                                <a href="{{ route('admin.users.detail', $withdrawal->user_id) }}">{{ @$withdrawal->user->aam_id }}</a>
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Method')
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Type')
                            <span class="fw-bold">
                                @if($withdrawal->type == 'profit_bonus')
                                    {{ __('Referal Profit') }}
                                @elseif($withdrawal->type == 'user_profit_bonus')
                                    {{ __('Profit Bonus') }}
                                @elseif($withdrawal->type == 'deposit_commission')
    ...
    <div class="row mb-30 mt-30">
        <div class="col-lg-12 col-md-12 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="card-title border-bottom pb-2">@lang('User Withdraw list Information')</h5>
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <table class="table">
                                <thead>
                                ...
                                <tbody>
                                    @forelse($withdrawals as $withdrawal)
                                        <tr>
                                            ...
                                            <td>{{ $general->cur_sym . showAmount($withdrawal->amount) }}</td>
                                            <td>{{ $withdrawal->currency . ' ' . showAmount($withdrawal->final_amount) }}</td>
                                        </tr>
                                    @empty
                                    <tr>
