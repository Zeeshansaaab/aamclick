                ...
                <form action="" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-4 d-none configForm" id="infobip">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="fw-bold">@lang('User ID') </label>
                                    <input type="text" class="form-control" placeholder="@lang('User ID')" name="infobip_username" value="{{ @$general->sms_config->infobip->aam_id }}"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row mt-4 d-none configForm" id="smsBroadcast">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="fw-bold">@lang('User ID') </label>
                                    <input type="text" class="form-control" placeholder="@lang('User ID')" name="sms_broadcast_username" value="{{ @$general->sms_config->sms_broadcast->aam_id }}"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row mt-4 d-none configForm" id="textMagic">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="fw-bold">@lang('User ID') </label>
                                    <input type="text" class="form-control" placeholder="@lang('User ID')" name="text_magic_username" value="{{ @$general->sms_config->text_magic->aam_id }}"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
