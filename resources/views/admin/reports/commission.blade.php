                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('User')">
                                        ...
                                        <br>
                                        <span class="small"> <a href="{{ route('admin.users.detail', $data->userTo->id) }}"><span>@</span>{{ $data->userTo->aam_id }}</a> </span>
                                    </td>
                                    ...
                                    <td data-label="@lang('Level - From')">
                                        ...
                                        <br>
                                        <span class="small"> <a href="{{ route('admin.users.detail', $data->userFrom->id) }}"><span>@</span>{{ $data->userFrom->aam_id }}</a> </span>
                                    </td>
