            ...
            <div class="card-body">
                ...
                @foreach($referrals->where('commission_type',$key) as $referral)
                    <li class="list-group-item d-flex flex-wrap justify-content-between">
                        ...
                        <span class="fw-bold">@lang('Plan') {{ $referral->plan->name }}</span>
...
@push('script')
    ...
    (function($){
        ...
        $(".generate").on('click', function () {
            ...
            let plan = $(this).parents('.card-body').find('[name="plan_id"]');
            // let plan_id = $('select[name=plan_id] option').filter(':selected').val()
            generrateLevels($this,plan);
        });
        ...
        function generrateLevels($this,plan){
