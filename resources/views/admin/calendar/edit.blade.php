                        ...
                        <div class="row">
                            <div class="col-xl-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control has-append" name="start_date" value="{{ $calendar->start }}" placeholder="@lang('Profit %age')" required>
                            ...
                            <div class="col-xl-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control has-append" name="profit" value="{{ $calendar->title }}" placeholder="@lang('Profit %age')" required>
