                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label> @lang('Profit Bonus Percentage')</label>
                                    <div class="input-group">
                                        <input class="form-control" type="number" step="any" name="profit_bonus_percentage" required value="{{$general->profit_bonus_percentage}}">
                                        <span class="input-group-text">{{ __($general->cur_text) }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label> @lang('Profit Bonus Days')</label>
                                    <div class="input-group">
                                        <input class="form-control" type="number" step="any" name="profit_bonus_days" required value="{{$general->profit_bonus_days}}">
                                        <span class="input-group-text">%</span>
                                    </div>
                                </div>
                            </div>
