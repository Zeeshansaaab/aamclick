    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.users.tracker.*')}}">
                    <a href="{{route('admin.users.tracker.index')}}" class="nav-link ">
                        <i class="menu-icon las la-link"></i>
                        <span class="menu-title">@lang('Profit Tracker')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.calendar*',3)}}">
                        <i class="menu-icon las la-calendar-alt"></i>
                        <span class="menu-title">@lang('Calendar')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.calendar*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.calendar.index')}} ">
                                <a href="{{route('admin.calendar.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Calendar Profit List')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.calendar.create')}} ">
                                <a href="{{route('admin.calendar.create')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Add Today Profit')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.committee.plan*',3)}}">
                        <i class="menu-icon las la-users"></i>
                        <span class="menu-title">@lang('Committee System')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.committee.plan*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.committee.plan.index')}} ">
                                <a href="{{route('admin.committee.plan.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.committee.plan.index')}} ">
                                <a href="{{route('admin.committee.plan.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Add New Plan')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.committee.members*',3)}}">
                        <i class="menu-icon las la-users"></i>
                        <span class="menu-title">@lang('Committee Members')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.committee.members*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.committee.members.index')}} ">
                                <a href="{{route('admin.committee.members.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.devideProfit*',3)}}">
                        <i class="menu-icon las la-users"></i>
                        <span class="menu-title">@lang('Add Profit')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.devideProfit*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.devideProfit.dailyProfit')}} ">
                                <a href="{{route('admin.devideProfit.dailyProfit')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Add Daily Profit')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.devideProfit.form')}} ">
                                <a href="{{route('admin.devideProfit.form')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Devide Profit')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
